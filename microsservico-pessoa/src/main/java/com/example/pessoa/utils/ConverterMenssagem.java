package com.example.pessoa.utils;
...
public class ConverterMenssagem {
    ...
    public String serializar(Object mensagem) throws JsonProcessingException {
        return OBJECT_MAPPER.writeValueAsString(mensagem);
    }
